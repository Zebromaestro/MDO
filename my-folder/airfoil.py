...
opti.subject_to([
    aero["analysis_confidence"] > 0.90, #neural foil predictions must be within 90% tolerance
...
airfoils_and_colors = {
    ...
    # FIXED LINE: Replaced the file-based airfoil with a built-in one.
    "XFoil-Optimized (DAE-21)": (asb.Airfoil("dae21").to_kulfan_airfoil(), "darkgreen"),
